...
import CloudOrganizationInfoPage from './CloudOrganizationInfoPage';

type Args = ComponentProps<typeof CloudOrganizationInfoPage>;

export default {
  title: 'pages/CloudOrganizationInfoPage',
  component: CloudOrganizationInfoPage,
  parameters: {
  ...
  args: {
    ...
    subtitle: 'Organization info will help us personalize your workspace',
    currentStep: 1,
    stepCount: 1,
...
export const _CloudOrganizationInfoPage: Story<Args> = (args) => (
  <CloudOrganizationInfoPage {...args} />
);
